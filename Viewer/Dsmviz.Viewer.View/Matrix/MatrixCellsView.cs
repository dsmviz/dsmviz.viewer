    ...
    public class MatrixCellsView : MatrixFrameworkElement
    {
        ...
        private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            if (DataContext is IMatrixViewModel matrixViewModel)
            {
                ...
                _matrixCellsViewModel.RedrawRequested += OnRedrawRequested;
            }
        }
        ...
        {
            if (e.PropertyName == nameof(IMatrixCellsViewModel.ToolTipText))
            {
                ToolTip = _matrixCellsViewModel?.ToolTipText;
            }
        }
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if ((_hoveredRow != row) || (_hoveredColumn != column))
            {
                ...
                _matrixCellsViewModel?.ContentChanged(ContentChangeType.Hover);
            }
        }
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            _matrixCellsViewModel?.ContentChanged(ContentChangeType.Selection);
        }
