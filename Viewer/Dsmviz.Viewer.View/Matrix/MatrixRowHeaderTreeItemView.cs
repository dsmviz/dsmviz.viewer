    ...
    public class MatrixRowHeaderTreeItemView : MatrixFrameworkElement
    {
        ...
        private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (_rowHeaderItemViewModel != null)
            {
                ...
                ToolTip = _rowHeaderItemViewModel.ToolTipText;
        ...
        {
            if (e.PropertyName == nameof(IMatrixRowHeaderTreeItemViewModel.ToolTipText))
            {
                ToolTip = _rowHeaderItemViewModel?.ToolTipText;
            }
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (_rowHeaderItemViewModel != null && !_isHovered)
            {
                ...
                _isHovered = true;
                _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.Hover);
            }
        ...
        protected override void OnMouseDown(MouseButtonEventArgs e)
        {
            if (_rowHeaderItemViewModel != null)
            {
                ...
                {
                    if (_rowHeaderItemViewModel.ToggleElementExpanded())
                    {
                        _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.Expanded);
                    }
                }
                else
                {
                    _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.Selection);
                }
            }
        ...
        protected override void OnDragEnter(DragEventArgs e)
        {
            ...
            _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.DragEnter);
        }
        ...
        protected override void OnDragLeave(DragEventArgs e)
        {
            _isValidDropTarget = false;
            _isInvalidDropTarget = false;
            _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.DragLeave);
        }
        ...
        protected override void OnDrop(DragEventArgs e)
        {
            ...
            if (e.Data.GetDataPresent(DataObjectName))
            {
                    ...
                    (dragged != dropTarget))
                {
                    ...
                    _matrixRowHeaderViewModel.ChangeElementParent(dragged.Element, dropTarget.Element, index);
                }
            ...
            _isValidDropTarget = false;
            e.Handled = true;
            _matrixRowHeaderViewModel.ContentChanged(ContentChangeType.DragDrop);
        }
        ...
        {
            if (_rowHeaderItemViewModel is { IsExpandable: true })
            {
                if (_isHovered)
                {
                    dc.DrawText(
