    ...
    public class MatrixRowMetricsView : MatrixFrameworkElement
    {
        ...
        private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            if (DataContext is IMatrixViewModel matrixViewModel)
            {
                ...
                _matrixRowMetricsViewModel.RedrawRequested += OnRedrawRequested;
            }
        }
        ...
        {
            if (e.PropertyName == nameof(IMatrixRowMetricsViewModel.ToolTipText))
            {
                ToolTip = _matrixRowMetricsViewModel?.ToolTipText;
            }
        }
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (_hoveredRow != row)
            {
                ...
                _matrixRowMetricsViewModel?.ContentChanged(ContentChangeType.Hover);
            }
        }
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            _matrixRowMetricsViewModel?.ContentChanged(ContentChangeType.Selection);
        }
