...
namespace Dsmviz.Interfaces.ViewModel.Matrix
{
    public interface IMatrixViewModel
    {
        ...
        IMatrixRowSideBarViewModel MatrixRowSideBarViewModel { get; }
        IMatrixColumnSideBarViewModel MatrixColumnSideBarViewModel { get; }
        IMatrixCellSideBarViewModel MatrixCellSideBarViewModel { get; }
