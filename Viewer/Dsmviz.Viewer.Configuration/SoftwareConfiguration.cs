...
using Dsmviz.Viewer.Application.Storage;
...
namespace Dsmviz.Viewer.Configuration
{
    public class SoftwareConfiguration
    {
        public static MainViewModel CreateMainViewModel()
        {
            ...
            StorageFacade storage = new StorageFacade(store, model, editing.ActionManagement);

            return new MainViewModel("Dsmviz", editing, query, matrix, metrics, storage);
        }
    }
}