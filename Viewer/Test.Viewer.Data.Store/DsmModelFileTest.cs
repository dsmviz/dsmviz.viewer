...
namespace Dsmviz.Test.Data.Store
{
    ...
    public class DsmModelFileTest
    {
        ...
        public void TestLoadModel()
        {
            ...
            string inputFile = "Validation.Input.dsm";
            ...
            IDictionary<string, List<IMetaDataItem>> metaData = dataModel.MetaDataModelImport.GetMetaDataItems();
            ...
            Element? rootElement = dataModel.ElementModelImport.GetRootElement() as Element;
            ...
            List<IRelation> relations = dataModel.RelationModelImport.GetPersistedRelations().OrderBy(r => r.Id).ToList();
        ...
        public void TestSaveModel()
        {
            ...
            string inputFile = "Validation.Input.dsm";
            string outputFile = "Validation.Output.dsm";
        ...
        {
            dataModel.MetaDataModelImport.ImportMetaDataItem("group1", "item1", "value1");
            dataModel.MetaDataModelImport.ImportMetaDataItem("group1", "item2", "value2");
            dataModel.MetaDataModelImport.ImportMetaDataItem("group2", "item3", "value3");
            dataModel.MetaDataModelImport.ImportMetaDataItem("group2", "item4", "value4");
            ...
            IElement a = dataModel.ElementModelImport.ImportElement(11, "a", "", elementProperties, 1, true, true, null);
            IElement a1 = dataModel.ElementModelImport.ImportElement(12, "a1", "eta", null, 2, false, false, 11);
            IElement a2 = dataModel.ElementModelImport.ImportElement(13, "a2", "eta", null, 3, false, false, 11);
            IElement b = dataModel.ElementModelImport.ImportElement(14, "b", "", null, 4, false, false, null);
            IElement b1 = dataModel.ElementModelImport.ImportElement(15, "b1", "etb", null, 5, false, false, 14);
            IElement b2 = dataModel.ElementModelImport.ImportElement(16, "b2", "etb", null, 6, false, false, 14);
            IElement c = dataModel.ElementModelImport.ImportElement(17, "c", "", null, 7, false, false, null);
            IElement c1 = dataModel.ElementModelImport.ImportElement(18, "c1", "etc", null, 8, false, false, 17);
            IElement c2 = dataModel.ElementModelImport.ImportElement(19, "c2", "etc", null, 9, false, true, 17);
            ...
            dataModel.RelationModelImport.ImportRelation(91, a1, b1, "ra", 1000, relationProperties);
            dataModel.RelationModelImport.ImportRelation(92, a2, b1, "ra", 200, null);
            dataModel.RelationModelImport.ImportRelation(93, a1, b2, "ra", 30, null);
            dataModel.RelationModelImport.ImportRelation(94, a2, b2, "ra", 4, null);
            dataModel.RelationModelImport.ImportRelation(95, a1, c2, "ra", 5, null);
            dataModel.RelationModelImport.ImportRelation(96, b2, a1, "rb", 1, null);
            dataModel.RelationModelImport.ImportRelation(97, b2, a2, "rb", 2, null);
            dataModel.RelationModelImport.ImportRelation(98, c1, a2, "rc", 4, null);
        }
    }
}
