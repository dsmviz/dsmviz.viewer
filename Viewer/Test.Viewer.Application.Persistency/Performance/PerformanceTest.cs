...
namespace Dsmviz.Test.Application.Persistency.Performance
{
    ...
    public class PerformanceTest
    {
        ...
        public void TestModelLoadPerformance()
        {
            ...
            CoreDataStore storage = new CoreDataStore(model);
            ...
            storage.LoadModel(inputFilename, _fileProgress.Object);
        ...
        public void TestModelSavePerformance()
        {
            ...
            storage.SaveModel(outputFilename, false, _fileProgress.Object);
